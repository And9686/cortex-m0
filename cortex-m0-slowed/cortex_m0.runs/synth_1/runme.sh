...
HD_PWD='C:/Users/aluno/Documents/cortex-m0-v3/cortex-m0-slowed/cortex_m0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log demonstration.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source demonstration.tcl
