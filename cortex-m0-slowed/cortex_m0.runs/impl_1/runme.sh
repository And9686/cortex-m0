...
HD_PWD='C:/Users/aluno/Documents/cortex-m0-v3/cortex-m0-slowed/cortex_m0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log demonstration.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source demonstration.tcl -notrace
